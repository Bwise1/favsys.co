...
export default function Header() {
  ...
  return (
    <div id="home">
      <nav
        className={
          "shadow-sm fixed w-full backdrop-filter backdrop-blur-lg bg-opacity-50 z-10 " +
          (colorChange ? "bg-white" : "bg-inherit")
        }
      >
            ...
            <div className="flex md:hidden ">
              ...
              >
                ...
                {!isOpen ? (
                  ...
                  >
                    <path
                      d="M12 0.875H34.8571C37.6186 0.875 39.8571 3.11358 39.8571 5.875V7.14286H12V0.875Z"
                      fill="black"
                    />
                    <path
                      d="M0 12.0178H40.3929V18.9821H0V12.0178Z"
                      fill="black"
                    />
                    <path
                      d="M0 23.8572H40.3929V30.125H5C2.23858 30.125 0 27.8865 0 25.125V23.8572Z"
                      fill="black"
                    />
                  </svg>
                ) : (
                  ...
                  >
                    <path
                      d="M9 6L23.5364 20.5364L21.0301 23.0427L6.49372 8.50628L9 6Z"
                      fill="black"
                    />
                    <path
                      d="M5.74463 20.7444L20.281 6.20796L22.5367 8.46362L8.00028 23L5.74463 20.7444Z"
                      fill="black"
                    />
                  </svg>
                )}
